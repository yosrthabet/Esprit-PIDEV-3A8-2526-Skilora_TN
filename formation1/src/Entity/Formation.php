...
class Formation
{
    ...
    #[ORM\Column(name: 'lessons_count', nullable: true)]
    ...
    #[Assert\NotNull(message: 'formation.level.not_blank', groups: self::FORMATION_GROUPS)]
    #[Assert\Choice(
        choices: [FormationLevel::BEGINNER, FormationLevel::INTERMEDIATE, FormationLevel::ADVANCED],
        message: 'formation.level.choice',
        groups: self::FORMATION_GROUPS,
    )]
