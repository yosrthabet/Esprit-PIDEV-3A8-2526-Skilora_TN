...
final class JobOfferController extends AbstractController
{
    ...
    public function index(
        ...
        $jobs = [];
        if ($company !== null) {
            $jobs = $jobOfferRepository->findByCompanyFiltered($company, $filter, $search, $workType);
        }
    ...
    public function show(JobOffer $jobOffer, JobOfferManager $jobOfferManager): Response
    {
        /** @var User $user */
        $user = $this->getUser();
